...
3. Copiar `TEMPLATE.md` pra um arquivo novo (ex.: `2026-07-26-bakery.md`)
   e registrar as observações — o que o Lovable mostrou de diferente do
   nosso resultado.
4. Repetir esse processo ao longo do tempo. Só quando o **mesmo padrão**
   ...
   isolada), ele vira candidato a mudança real.
